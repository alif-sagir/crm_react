                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div className="progress bg-transparent progress-sm">
                                                                <div className="progress-bar bg-primary rounded" role="progressbar" style={{ "widh": "94%", "aria-valuenow": "94", "aria-valuemin": "0", "aria-valuemax": "100" }}>
                                                                    {/* "width: 94%" aria-valuenow="94" aria-valuemin="0" aria-valuemax="100"> */}
                                                        ...
                                                        <td>
                                                            <div className="progress bg-transparent progress-sm">
                                                                <div className="progress-bar bg-success rounded" role="progressbar"
                                                                    ...
                                                                    style={{ "widh": "82%", "aria-valuenow": "82", "aria-valuemin": "0", "aria-valuemax": "100" }}>
                                                        ...
                                                        <td>
                                                            <div className="progress bg-transparent progress-sm">
                                                                <div className="progress-bar bg-warning rounded" role="progressbar"
                                                                    ...
                                                                    style={{ "widh": "70%", "aria-valuenow": "70", "aria-valuemin": "0", "aria-valuemax": "100" }}>
