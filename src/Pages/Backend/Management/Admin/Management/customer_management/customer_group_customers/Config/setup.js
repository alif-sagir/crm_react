let prefix = 'customer_group_customer';
var setup = {
    prefix,
    route_prefix: 'customer-group-customer',
    api_prefix: 'customer-group-customer',
    layout_title: 'Customer group customer management',
    all_page_title: 'All',
    ...
    actions: {
        ...
        fetch_all_customer_group: async () => null,
...
setup.set_async = function (async_actions, dataStoreSlice) {
    ...
    setup.actions.fetch_all_customer_group = async (query_params) => await setup.dispatch(async_actions[`fetch_all_customer_group`](query_params));
