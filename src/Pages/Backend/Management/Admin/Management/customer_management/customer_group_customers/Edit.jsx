...
function Edit() {
  ...
  const { get_users, set_data, update_data, fetch_all_customer, fetch_all_customer_group } = setup.actions;
  ...
  if (data_store.singleData) {
    const { customer_group_id, customer_id, email, password, confirm_password, id } = data_store.singleData;
    return (
      <div className="card list_card">
        <div className="card-header ">
          <h2 className="heading">Edit</h2>
          <div className="btns d-flex gap-2 align-items-center">
            <a href="#/dashboard/customer-group-customer" className="btn rounded-pill btn-outline-secondary">
                ...
                <div className="col-lg-8">
                  <div className="form-group mb-5">
                    ...
                    <div className="custom_form_el">
                      ...
                      <div>:</div>
                      <div>
                        <select defaultValue={data_store?.singleData?.customer_group_id} name="customer_group_id" id="">
                          {
