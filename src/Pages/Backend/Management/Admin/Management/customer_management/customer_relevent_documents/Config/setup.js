let prefix = 'customer_relevent_document';
var setup = {
    prefix,
    route_prefix: 'customer-relevent-document',
    api_prefix: 'customer-relevent-document',
    layout_title: 'Customer relavent document management',
    all_page_title: 'All',
