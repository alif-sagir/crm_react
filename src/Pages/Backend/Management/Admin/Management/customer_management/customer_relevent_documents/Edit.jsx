...
function Edit() {
  ...
  if (data_store) {
    const { customer_id, document_path, email, password, confirm_password, id  } = data_store;
  return (
              ...
              <div className="col-lg-8">
                <div className="form-group mb-5">
                  ...
                  <div className="custom_form_el">
                    ...
                    <div>:</div>
                    <div><input name="document_path" type="text" className="form-control" defaultValue={document_path} /></div>
                  </div>
                </div>
              </div>
            </div>
