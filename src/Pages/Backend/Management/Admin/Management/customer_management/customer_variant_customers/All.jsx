                                        ...
                                        <td>
                                            <span className='edit_class_submanu_active'><i className="mdi mdi-format-list-bulleted"></i>
                                                <div className='edit_class_submanu'>
                                                    <ul>
                                                        <li>
                                                            <Link to={`/dashboard/customer-variant-customer/edit/${item.customer_id}`}>Edit</Link>
                                                        </li>
                                                        <li>
                                                            <Link to={`/dashboard/customer-variant-customer/details/${item.customer_id}`}>Details</Link>
                                                        </li>
                                                        <li>
                                                            <Link to="/dashboard/customer-variant-customer/edit">Deactive</Link>
                                                        </li>
