let prefix = 'customer_contact_number';
var setup = {
    prefix,
    route_prefix: 'customer-contact-number',
    api_prefix: 'customer-contact-number',
    layout_title: 'Customer contact number management',
    all_page_title: 'All',
