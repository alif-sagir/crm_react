let prefix = 'contact_appointment_reason';
var setup = {
    prefix,
    route_prefix: 'contact-appointment-reason',
    api_prefix: 'contact-appointment-reason',
    layout_title: 'contact appointment reason management',
    all_page_title: 'All',
    ...
    actions: {
        ...
        fetch_all_reason: async () => null,
        fetch_all_appointment: async () => null,
...
setup.set_async = function (async_actions, dataStoreSlice) {
    ...
    setup.actions.fetch_all_reason = async (query_params) => await setup.dispatch(async_actions[`fetch_all_reason`](query_params));
    setup.actions.fetch_all_appointment = async (query_params) => await setup.dispatch(async_actions[`fetch_all_appointment`](query_params));
