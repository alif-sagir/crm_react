let prefix = 'contact_history_feedback';
var setup = {
    prefix,
    route_prefix: 'contact-history-feedback',
    api_prefix: 'contact-history-feedback',
    layout_title: 'contact history feedback management',
    all_page_title: 'All',
