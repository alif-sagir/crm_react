...
function Edit() {
  ...
  if (data_store) {
    const { contact_number_id, customer_id, date, contact_type, note, creator, id  } = data_store;
  return (
              ...
              <div className="col-lg-8">
                <div className="form-group mb-5">
                  ...
                  <div className="custom_form_el">
                    ...
                    <div>:</div>
                    <div><input name="contact_number_id" type="number" className="form-control" defaultValue={contact_number_id} /></div>
                  </div>
                  <div className="custom_form_el">
                    <label htmlFor="">Customer Id</label>
                    <div>:</div>
                    <div><input name="customer_id" type="number" className="form-control" defaultValue={customer_id} /></div>
                  </div>
                  <div className="custom_form_el">
                  ...
                  <div className="custom_form_el">
                    ...
                    <div>:</div>
                    <div><input name="creator" type="number" className="form-control" defaultValue={creator} /></div>
                  </div> 
                </div>
              </div>
            </div>
